                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-primary">{{ $mark->total_marks }}</td>
                            <td>{{ \Carbon\Carbon::parse($mark->exam_date)->format('d M Y') }}</td>
                            <td>
                                <a href="{{ route('marks.edit', $mark->id) }}" class="btn btn-sm btn-success">Edit</a>
                                <form action="{{ route('marks.delete', $mark->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
