        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <div class="form-floating">
              <input id="loginEmail" type="password" class="form-control" name="email" placeholder="password" required>
              <label for="loginEmail">Password</label>
            </div>
            <div class="form-floating">
                <input id="loginEmail" type="password" class="form-control" name="cpassword" placeholder="confirm-password" required>
                <label for="loginEmail">Password</label>
              </div>
